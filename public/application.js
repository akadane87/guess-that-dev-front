...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://aqueous-falls-94606.herokuapp.com',
...
/***/ function(module, exports) {
	...
	module.exports = { store: store, responseT: responseT, responseTotal: responseTotal };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var picsTemplate = __webpack_require__(12);
	var namesTemplate = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<li class=\"dev-flash-card\">\n  <img data-id="
	    ...
	    + " class=\"dev-picture\" src="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + " alt=\"dev picture\" />\n\n\n  <form class=\"name-check-form\">\n    <div class=\"form-group\">\n      <input class=\"name-response\" placeholder=\"Click Button to Enter Name\">\n    </div>\n    <div class=\"form-group name-list-handlebars\">\n    </div>\n    <div class=\"form-group\">\n      <button data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " class=\"button name-check-submit\" type=submit>Submit</button>\n    </div>\n    <p class=\"ufm-check\"></p>\n  </form>\n  </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pictures : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<button data-id="
	    ...
	    + " data-name="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + " class=\"button button-2 button-2d name-input\" type=button >"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</button>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pictures : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var g_api = __webpack_require__(34);
	var g_ui = __webpack_require__(35);
	var store = __webpack_require__(10);

	var onGetAllPictutes = function onGetAllPictutes(event) {
	  console.log('Get All Pics EVENTS');
	  event.preventDefault();
	  g_api.getAllPictures().then(g_ui.getAllPicturesSuccess).catch(g_ui.failure);
	  g_api.getGames().then(g_ui.getGamesSuccess).catch(g_ui.failure);
	};

	var onPostResponse = function onPostResponse(data) {
	  g_api.postResponse(data).then(g_ui.postResponseSuccess).catch(g_ui.failure);
	};

	var onDeleteAttempt = function onDeleteAttempt() {
	  g_api.deleteAttempt().then(g_ui.deleteAttemptSuccess).catch(g_ui.failure);
	};

	var onNewAttempt = function onNewAttempt(event) {
	  event.preventDefault();
	  g_api.newAttempt().then(g_ui.newAttemptSuccess).catch(g_ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deleteAttempt = function deleteAttempt(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/attempts',
	    method: 'DELETE',
	    data: data,
	...
	var newAttempt = function newAttempt() {
	  return $.ajax({
	    url: config.apiOrigin + '/attempts',
	    method: 'POST',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var picsTemplate = __webpack_require__(12);
	var namesTemplate = __webpack_require__(32);
	var attemptGames = __webpack_require__(36);
	var gameLogic = __webpack_require__(37);

	var getAllPicturesSuccess = function getAllPicturesSuccess(data) {
	...
	var postResponseSuccess = function postResponseSuccess(data) {
	  console.log('post response success' + data);
	};

	var deleteAttemptSuccess = function deleteAttemptSuccess(id) {
	  $('.ufm-game').html("Game History Cleared");
	  console.log("delete attempts success", +id);
	};

	var newAttemptSuccess = function newAttemptSuccess(data) {
	  console.log("new Attempt success" + data);
	};

	var getGamesSuccess = function getGamesSuccess(data) {
	  var whatvz = attemptGames({ data: data });
	...
	module.exports = {
	  getAllPicturesSuccess: getAllPicturesSuccess,
	  postResponseSuccess: postResponseSuccess,
	  newAttemptSuccess: newAttemptSuccess,
	  deleteAttemptSuccess: deleteAttemptSuccess,
	  failure: failure,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\nNew Game Created! You are on your\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addLogicEvents = function addLogicEvents(event) {
	  event.preventDefault();
	...
	var nameCheck = function nameCheck(event) {
	  event.preventDefault();
	  var submitId = $(event.target).attr('data-id');
	  var pictureId = $('.dev-picture').eq(submitId - 1).attr('data-id');
	  var responseTF = undefined;
